      ...
      <div className="lg:max-w-7xl max-w-2xl mx-auto p-4">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-8 max-md:justify-center mt-12">
          ...
          <div className="flex items-center max-sm:flex-col">
            ...
            />
            <div className="p-4 sm:ml-4">
              <h4 className="text-base font-extrabold">Jen Konecki</h4>
              <p className="text-xs mt-1">Marketing Specialist</p>
              <div className="mt-4">
                <p className="text-sm leading-relaxed">
                  Jen continuously manages demand and supply, doing whatever it
                  takes to secure interesting work and bring on passionate
                  people.
                </p>
              </div>
              <div className="space-x-4 mt-4">
          ...
          <div className="flex items-center max-sm:flex-col">
            ...
            />
            <div className="p-4 sm:ml-4">
              <h4 className="text-base font-extrabold">Sophia Patel</h4>
              <p className="text-xs mt-1">Project Manager</p>
              <div className="mt-4">
                <p className="text-sm leading-relaxed">
                  Sophia ensures seamless execution of complex initiatives by
                  aligning cross-functional stakeholders, managing risks, and
          ...
          <div className="flex items-center max-sm:flex-col">
            ...
            />
            <div className="p-4 sm:ml-4">
              <h4 className="text-base font-extrabold">Liam Gonzalez</h4>
              <p className="text-xs mt-1">Cybersecurity Specialist</p>
              <div className="mt-4">
                <p className="text-sm leading-relaxed">
